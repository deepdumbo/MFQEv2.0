...
We prepare 18 test videos in our [Dropbox](https://www.dropbox.com/sh/s9f9h7kdmetztz9/AAAz6Z1nEovKIqgDsXo34qFia?dl=0). Download the `Video` folder and put it in the same path with `main_test.py`. **Of course, you can download one video (raw one + compressed one) and give it a try~**
...
We prepare the estimated PQF labels of 18 compressed videos in folder `Data`.
