...
"""
QP_video = 37 # for the test video in this demo(BasketballPass), all frames are with QP37. Record the QP_video here.
...
for ite_CmpVideo in range(num_CmpVideo):
    ...
    CmpVideo_name = CmpVideo_path.split("/")[-1].split(".")[0]
    
    RawVideo_name = "_".join(CmpVideo_name.split("_")[0:3])
